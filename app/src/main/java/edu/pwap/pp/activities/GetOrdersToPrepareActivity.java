...
public class GetOrdersToPrepareActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buttonRefreshOrderToPrepare = findViewById(R.id.buttonRefreshOrderToPrepare);
    ...
    private Single<Order> prepareOrder(Order order)
    {
        ...
        Toast.makeText(GetOrdersToPrepareActivity.this,"Order " + order.getId()
